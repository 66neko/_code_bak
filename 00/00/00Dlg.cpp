...
BEGIN_MESSAGE_MAP(CMy00Dlg, CDialog)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	//}}AFX_MSG_MAP
	ON_BN_CLICKED(IDOK, &CMy00Dlg::OnBnClickedOk)
END_MESSAGE_MAP()
...
void CMy00Dlg::OnBnClickedOk()
{
	// TODO: 在此添加控件通知处理程序代码
	long long a,b;
	CString str;
	m_1.GetWindowTextA(str);
	a = atoi(str.GetBuffer(0));
	m_2.GetWindowTextA(str);
	b = atoi(str.GetBuffer(0));
	a += b;
	str.Format("%lld",a);
	m_3.SetWindowTextA(str);
}
